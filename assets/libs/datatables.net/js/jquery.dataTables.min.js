...
(function(h) {
    ...
    function P(a, b) {
        ...
        if (-1 !== h.inArray(!1, c)) D(a, !1);
            ...
            else if (i) { if (!a.bDestroying && !b) { nb(a); return } } else a.iDraw++;
            if (0 !==
                n.length) {
    ...
    function wb(a) {
        ...
        for (g = 0; g < c; g++) n = b[g], m = f[g], i = "function" == typeof n.mData ? "function" : n.mData, G.columns.push({ data: i, name: n.sName, searchable: n.bSearchable, orderable: n.bSortable, search: { value: m.sSearch, regex: m.bRegex } }),
    ...
    function ma(a) {
        ...
        if (a.scrollBarVis !== M && a.scrollBarVis !== k) a.scrollBarVis = M, aa(a);
            ...
            t && J(function(a) { a.style.width = "" }, R);
            f = p.outerWidth();
            if ("" === c) {
                u.width = "100%";
            ...
            J(function(a, b) { if (h.inArray(a, $b) !== -1) a.style.width = v[b] }, o);
            h(M).height(0);
            t && (J(B, R), J(function(a) {
                z.push(a.innerHTML);
                x.push(w(h(a).css("width")))
            }, R), J(function(a, b) { a.style.width = x[b] }, Q), h(R).height(0));
            J(function(a, b) {
    ...
    function Ib(a,
        b) { for (var c, d = -1, e = -1, f = 0, g = a.aoData.length; f < g; f++) c = B(a, f, b, "display") + "", c = c.replace(ac, ""), c = c.replace(/&nbsp;/g, " "), c.length > d && (d = c.length, e = f); return e }
            ...
            b = function(b) {
                if (b && b.time) {
                    ...
                    if (-1 === h.inArray(!1, g) && (g = a.iStateDuration, !(0 < g && b.time < +new Date - 1E3 * g) && !(b.columns && f.length !== b.columns.length))) {
                        ...
                        b.order !==
                            k && (a.aaSorting = [], h.each(b.order, function(b, c) { a.aaSorting.push(c[0] >= f.length ? [0, c[1]] : c) }));
    ...
    var l = function(a) {
            ...
            this.fnGetNodes =
                function(a) { var b = this.api(!0); return a !== k ? b.row(a).node() : b.rows().nodes().flatten().toArray() };
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) L(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    for (i = r.length; j < i; j++) {
                        var o = r[j];
                        if (o.nTable ==
                            this || o.nTHead && o.nTHead.parentNode == this || o.nTFoot && o.nTFoot.parentNode == this) { var s = g.bRetrieve !== k ? g.bRetrieve : m.bRetrieve; if (c || s) return o.oInstance; if (g.bDestroy !== k ? g.bDestroy : m.bDestroy) { o.oInstance.fnDestroy(); break } else { L(o, 0, "Cannot reinitialise DataTable", 3); return } }
        ...
        Rb = function(a, b, c) { return I(a) ? !0 : !(I(a) || "string" === typeof a) ? null : ab(a.replace(Ca, ""), b, c) ? !0 : null },
        C = function(a, b, c) {
            var d = [],
                e = 0,
                f = a.length;
    ...
    o("tables()", function(a) { return a !== k && a !== null ? new s(Vb(a, this.context)) : this });
    o("table()", function(a) {
        var a = this.tables(a),
            b = a.context;
    ...
    t("cells().invalidate()", "cell().invalidate()", function(a) { return this.iterator("cell", function(b, c, d) { ea(b, c, a, d) }) });
    ...
    l.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "Pertama", sLast: "Terakhir", sNext: "<i class='fas fa-arrow-right'></i>", sPrevious: "<i class='fas fa-arrow-left'></i>" },
    ...
    }, function(a, b) { var c = b.oLanguage.sDecimal; return ab(a, c, true) ? "num-fmt" + c : null }, function(a, b) { var c = b.oLanguage.sDecimal; return Rb(a, c) ? "html-num" + c : null }, function(a, b) { var c = b.oLanguage.sDecimal; return Rb(a, c, true) ? "html-num-fmt" + c : null }, function(a) { return I(a) || typeof a === "string" && a.indexOf("<") !== -1 ? "html" : null }]);
    h.extend(l.ext.type.search, {
        html: function(a) { return I(a) ? a : typeof a === "string" ? a.replace(Ob, " ").replace(Ca, "") : "" },
        string: function(a) {
            return I(a) ?
    ...
    h.extend(v.type.order, {
        ...
        "string-pre": function(a) { return I(a) ? "" : typeof a === "string" ? a.toLowerCase() : !a.toString ? "" : a.toString() },
